    ...
    public static void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (attackLanded && !crystalPlaced) {
                ...
                if (targetPos == null && now - attackTime >= cfg.crystalPlaceTime[0]) {
                ...
                // Try placing crystal
                if (targetPos != null && now - lastActionTime >= cfg.crystalPlaceTime[0]) {
                    if (tryPlaceCrystal()) {
                        crystalPlaced = true;
                        lastActionTime = now;
                    } else {
            ...
            else if (crystalPlaced && now - lastActionTime >= cfg.crystalAttackTime[0]) {
                if (detonateCrystal()) {
                    reset();
                } else {
                    reset();
